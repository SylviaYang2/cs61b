...
public class IntList {
    ...
    public static void evenOdd(IntList lst) {
        ...
        IntList oddList = lst.tail;
        IntList second = lst.tail;
        while (lst.tail != null && oddList.tail != null) {
            lst.tail = lst.tail.tail;
            oddList.tail = oddList.tail.tail;
            lst = lst.tail;
...
//        IntList L1 = list(1, 2, 3, 4, 5);
        IntList L2 = list(0, 3, 1, 4, 2, 5);
        evenOdd(L2);
        int count = 0;
        String s = "* B Beta III IV I AXLE (YF) (ZH)   ";
        String[] s1 = s.split(" ");
        for (String ele: s1) {
            count++;
